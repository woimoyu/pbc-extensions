...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.QiXiMH = exports.QiXiMHInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const QiXiMHParser_1 = require("./QiXiMHParser");
...
class QiXiMH extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        this.baseUrl = QX_DOMAIN;
        ...
        this.RETRY = 5;
        this.parser = new QiXiMHParser_1.Parser();
...
exports.QiXiMH = QiXiMH;
//special thanks to Netsky and xOnlyFadi and author of Qiximh.kt from tachiyomi-extensions.

}).call(this)}).call(this,require("buffer").Buffer)
},{"./QiXiMHParser":83,"buffer":2,"paperback-extensions-common":8}],83:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseChapters($, apiData, mangaId, source) {
        const chapters = [];
    ...
    parseHomeSections($, sectionCallback) {
        const section1 = createHomeSection({ id: '1', title: '今日热读', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section2 = createHomeSection({ id: '2', title: '新番漫画', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
        const section3 = createHomeSection({ id: '3', title: '最近更新', type: paperback_extensions_common_1.HomeSectionType.singleRowNormal, view_more: false });
    ...
    handleHomeSection($, sectionFrom) {
        ...
        for (const obj of sectionFrom) {
            ...
            sectionTo.push(createMangaTile({
                id,
                image,
                title: createIconText({ text: title })
            }));
